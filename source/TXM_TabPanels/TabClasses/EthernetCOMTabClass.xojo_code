#tag Class
Protected Class EthernetCOMTabClass
Inherits TabClass
	...
	#tag Method, Flags = &h0
		Function CreateContainer() As ContainerControl
		  ...
		  If container = Nil Then
		    container = new EthernetCOMTabContainer(Self)
		  End
		  Return container
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h1
		Protected Function FitsForStep(theStep as BasicClass, ByRef isDefaultOut as Boolean) As Boolean
		  ...
		  if theStep isA TCP_ResourceClass AND NOT (theStep IsA PIIOX.PIIOX_ResourceClass) then
		    isDefaultOut = true
		    return true
		  end if
		End Function
